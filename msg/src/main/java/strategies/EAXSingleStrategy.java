...
public class EAXSingleStrategy {
	private Tour tourA;
	private Tour tourB;
	...
	public EAXSingleStrategy(Tour tourA, Tour tourB) {
		this.tourA = tourA;
		this.tourB = tourB;
	...
	public Tour startEAXSingleStrategy(int numOfChildren) {
		...
		List<List<Integer>> list = createABCycleSingleStrategy();
		List<Integer> tempTour = new ArrayList<Integer>();
		List<Integer> solution = new ArrayList<Integer>();
		double distance = tourA.getDistance();
		for (List<Integer> li : list) {
			if (!li.isEmpty()) {
				tempTour = createIntermediateSolution(createESetsSingleStrategy(li, this.tourA));
...
//			}
	...
	public List<List<Integer>> createABCycleSingleStrategy() {

		List<List<Integer>> numOfESets = new ArrayList<List<Integer>>(numOfChildren);
		...
		tempTourB = mapTourB.entrySet().stream()
                .collect(Collectors.toMap(Map.Entry::getKey, e -> new ArrayList<Integer>(e.getValue())));
		for (int j = 0; !tempTourA.isEmpty()&&j < numOfChildren ; ++j) {
